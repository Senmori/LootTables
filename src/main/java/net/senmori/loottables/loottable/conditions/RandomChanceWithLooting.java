...
public class RandomChanceWithLooting implements LootCondition {
    ...
    /**
     * Test if a random number between 0.0 and 1.0 is less than a specified value, affected by the Looting level
     * on the killer entity.
     *
     * @param chance Success rate between 0.0 and 1.0
     * @param lootingMultiplier Looting adjustment to the base success rate.
 *                              Formula: chance + (looting_level * looting_multiplier)
     */
