...
public class LootingEnchantBonus extends LootFunction {
     ...
     *
     * @param count Specifies an exact number of additional items per level of looting.
     *              Or it can be a list of two numbers which specify the minimum and maximum number of additional items.
     * @param limit Specifies the maximum amount of items in the stack after caclulation. If value is 0, no limit is applied.
    ...
    /**
     * Adjusts the stack size based on the level of the Looting {@link Enchantment} on the killer entity.
     * The limit is defaulted to 0, and the conditions are null-valued with this constructor.
     *
     * @param count Specifies an exact number of additional items per level of looting.
     *              Or it can be a list of two numbers which specify the minimum and maximum number of additional items.
     */
